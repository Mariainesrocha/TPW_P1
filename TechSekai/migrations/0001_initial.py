    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other/Not specified')], max_length=20)),
                ...
                ('role', models.CharField(choices=[('A', 'Admin'), ('C', 'Client'), ('S', 'Shop')], max_length=10)),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TechSekai.address')),
